...
public class MethodImplementationTest {
	...
	public void testExecute() throws NoSuchMethodException, SecurityException {
		...
		final Optional<ApplicationAppendix<Integer>> a1 = resultState.getAppendixOfClass(Appendix_A1.class);
		assertThat(a1)
				.isNotEmpty();
		...
		final Optional<ApplicationAppendix<String>> a2 = resultState.getAppendixOfClass(Appendix_A2.class);
		assertThat(a2)
				.isNotEmpty();
		assertThat(a2.get())
